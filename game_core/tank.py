...
class Tank:
    ...
    def __init__(self, game_display, pos, health_bar_pos, color):
        ...
        :param health_bar_pos: position of health bar as tuple
    ...
    def draw_health_bar(self, active=False):
        ...
        if active:
            color = white
        pygame.draw.rect(self.game_display, color, (self.health_bar_position[0], self.health_bar_position[1], self.tank_health, 25))
